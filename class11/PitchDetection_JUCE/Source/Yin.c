...
void Yin_cumulativeMeanNormalizedDifference(Yin *yin){
	...
	for (tau = 1; tau < yin->halfBufferSize; tau++) {
        ...
        runningSum = runningSum == 0. ? 0.00000001 : runningSum;
		yin->yinBuffer[tau] *= tau / runningSum;
	}
//    printf("yin->halfBufferSize: %d\n", yin->halfBufferSize);
//    printf("runningSum: %.4f\n", runningSum);
}
...
//    printf("yin->halfBufferSize: %d\n", yin->halfBufferSize);
//    printf("yin->yinBuffer[tau + 1]: %.4f\n", yin->yinBuffer[tau + 1]);
//    printf("yin->yinBuffer[tau]: %.4f\n", yin->yinBuffer[tau]);
...
//    printf("buffer[0] in Yin_getPitch: %d\n", buffer[0]);
